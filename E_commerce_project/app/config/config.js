...
// MongoDB Configuration - Use environment variable for connection string
export const DATABASE = process.env.MONGODB_URI || "mongodb://localhost:27017/MernEcommerce";

// JWT Configuration
export const JWT_KEY = process.env.JWT_KEY || "default-jwt-key-change-in-production";
export const JWT_EXPIRE_TIME = parseInt(process.env.JWT_EXPIRE_TIME) || 30 * 24 * 60 * 60;

// Email Configuration
export const EMAIL_HOST = process.env.EMAIL_HOST || "mail.example.com";
